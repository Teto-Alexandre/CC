...
## 進捗
    ...
    execute if entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] as @a[tag=tds_tempa] if entity @s[advancements={ui:add/kill/moving=false}] run advancement grant @s only ui:add/kill/moving
