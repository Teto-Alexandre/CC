...
execute if score $module ui_world matches 1 if score @s module matches 47 unless score @s ui_dc_delay matches 1.. run scoreboard players set @s ui_dc_delay 20
