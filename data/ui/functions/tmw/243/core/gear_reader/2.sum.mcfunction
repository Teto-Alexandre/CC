...
scoreboard players operation @s shoot_speed < #127 ui_num
scoreboard players operation @s move_speed < #154 ui_num
scoreboard players operation @s blast_protection < #18 ui_num
scoreboard players operation @s norma_damage < #1180 ui_num
scoreboard players operation @s sub_damage < #127 ui_num
scoreboard players operation @s vsobj_damage < #235 ui_num
scoreboard players operation @s blast_damage < #136 ui_num
scoreboard players operation @s respawn_acc < #190 ui_num
scoreboard players operation @s death_sp < #105 ui_num
scoreboard players operation @s sp_need_acc < #145 ui_num
scoreboard players operation @s ink_regen < #145 ui_num
scoreboard players operation @s main_eff_acc < #145 ui_num
scoreboard players operation @s sub_eff_acc < #145 ui_num
