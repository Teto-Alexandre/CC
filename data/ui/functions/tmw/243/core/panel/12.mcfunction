...
# メニュー表示
    ...
    item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:121455,display:{Name:'{"text":"[ジェットパック]","color":"white","italic":false}',Lore:['{"text":"空を飛び爆発するショットを発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.3 with gray_stained_glass_pane{CustomModelData:121456,display:{Name:'{"text":"[バウンシーボム]","color":"white","italic":false}',Lore:['{"text":"地面で跳ねる爆弾を発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.4 with gray_stained_glass_pane{CustomModelData:121457,display:{Name:'{"text":"[トリプルトルネード]","color":"white","italic":false}',Lore:['{"text":"３つの竜巻を発生させる装置を投げる","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.5 with gray_stained_glass_pane{CustomModelData:121458,display:{Name:'{"text":"[ウルトラショット]","color":"white","italic":false}',Lore:['{"text":"螺旋を描く３つの弾を発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.6 with gray_stained_glass_pane{CustomModelData:121459,display:{Name:'{"text":"[ロケッティア]","color":"white","italic":false}',Lore:['{"text":"大量のミサイルを敵に発射する","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    ...
    item replace entity @s enderchest.11 with gray_stained_glass_pane{CustomModelData:121460,display:{Name:'{"text":"[ナイスダマ]","color":"white","italic":false}',Lore:['{"text":"長押しでチャージできる爆発弾","color":"aqua","italic":false}','{"text":"発動中はダメージ大幅カット","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.12 with gray_stained_glass_pane{CustomModelData:121461,display:{Name:'{"text":"[ウルトラハンコ]","color":"white","italic":false}',Lore:['{"text":"至近距離を連続で爆破する","color":"aqua","italic":false}','{"text":"発動中は跳躍力上昇","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
