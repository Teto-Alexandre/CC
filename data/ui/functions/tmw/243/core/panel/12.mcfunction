...
# メニュー表示
    ...
    item replace entity @s enderchest.12 with gray_stained_glass_pane{CustomModelData:121461,display:{Name:'{"text":"[ウルトラハンコ]","color":"gray","italic":false}',Lore:['{"text":"至近距離を連続で爆破する","color":"aqua","italic":false}','{"text":"発動中は跳躍力上昇","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
