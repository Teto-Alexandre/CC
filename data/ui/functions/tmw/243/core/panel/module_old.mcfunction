...
execute if entity @s[advancements={ui:hidden/misc/enemy_base=true}] run item replace entity @s enderchest.3 with barrier{display:{Name:'{"text":"404 not found","color": "dark_red","bold": true,"italic": false}',Lore:['{"text":"最初のリスポーン地点が他のチームになる","color": "gray","italic": false}']},ui:{ismenu:1}}
