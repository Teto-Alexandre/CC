...
execute if score $fusion_plus party_mode matches 1 run item replace entity @s enderchest.24 with lime_stained_glass_pane{display:{Name:'{"text":"超スペシャル融合: ON","italic": false}'},ui:{ismenu:1}}
execute unless score $fusion_plus party_mode matches 1 run item replace entity @s enderchest.24 with red_stained_glass_pane{display:{Name:'{"text":"超スペシャル融合: OFF","italic": false}'},ui:{ismenu:1}}
execute if score $slot ui_temp matches 24 unless score $fusion_plus party_mode matches 1 run tellraw @a [{"text":"> ","color": "gray"},{"selector":"@s"},{"text":"が超スペシャル融合を無効化しました","color": "gray"}]
execute if score $slot ui_temp matches 24 if score $fusion_plus party_mode matches 1 run tellraw @a [{"text":"> ","color": "gray"},{"selector":"@s"},{"text":"が超スペシャル融合を有効化しました","color": "gray"}]
