...
item replace entity @s enderchest.1 with black_concrete{display:{Name:'{"text":"チャージアップ！","color": "red","bold": true,"italic": false}',Lore:['{"text":"ゲーム開始時からSPゲージが最大","color": "gray","italic": false}']},ui:{ismenu:1}}
item replace entity @s enderchest.2 with black_concrete{display:{Name:'{"text":"最低保障プログラム","color": "blue","bold": true,"italic": false}',Lore:['{"text":"ゲーム開始時、死亡時に有効化","color": "gray","italic": false}','{"text":"SPゲージが半分まで溜まる","color": "gray","italic": false}']},ui:{ismenu:1}}
item replace entity @s enderchest.3 with black_concrete{display:{Name:'{"text":"達人の間合い10","color": "white","bold": true,"italic": false}',Lore:['{"text":"攻撃命中時、相手との距離が10mなら","color": "gray","italic": false}','{"text":"ダメージが2倍になる","color": "gray","italic": false}','{"text":"少しズレてもある程度ダメージは増える","color": "gray","italic": false}','{"text":"それ以外のダメージは減少する","color": "red","italic": false}']},ui:{ismenu:1}}
item replace entity @s enderchest.4 with black_concrete{display:{Name:'{"text":"達人の間合い15","color": "white","bold": true,"italic": false}',Lore:['{"text":"攻撃命中時、相手との距離が15mなら","color": "gray","italic": false}','{"text":"ダメージが2倍になる","color": "gray","italic": false}','{"text":"少しズレてもある程度ダメージは増える","color": "gray","italic": false}','{"text":"それ以外のダメージは減少する","color": "red","italic": false}']},ui:{ismenu:1}}
item replace entity @s enderchest.5 with black_concrete{display:{Name:'{"text":"達人の間合い20","color": "white","bold": true,"italic": false}',Lore:['{"text":"攻撃命中時、相手との距離が20mなら","color": "gray","italic": false}','{"text":"ダメージが2倍になる","color": "gray","italic": false}','{"text":"少しズレてもある程度ダメージは増える","color": "gray","italic": false}','{"text":"それ以外のダメージは減少する","color": "red","italic": false}']},ui:{ismenu:1}}
item replace entity @s enderchest.6 with black_concrete{display:{Name:'{"text":"びっくりチキン","color": "yellow","bold": true,"italic": false}',Lore:['{"text":"攻撃命中時、相手との距離が25mに近いほど","color": "gray","italic": false}','{"text":"ダメージが上昇する","color": "gray","italic": false}','{"text":"25mより遠くなると威力は激減","color": "red","italic": false}','{"text":"15mより近くても激減する","color": "red","italic": false}']},ui:{ismenu:1}}
item replace entity @s enderchest.7 with black_concrete{display:{Name:'{"text":"アンターボチャージャー","color": "green","bold": true,"italic": false}',Lore:['{"text":"徐々にSPゲージが上昇する","color": "gray","italic": false}']},ui:{ismenu:1}}
...
item replace entity @s enderchest.13 with gray_stained_glass_pane{display:{Name:'{"text":""}'},ui:{ismenu:1}}
item replace entity @s enderchest.14 with gray_stained_glass_pane{display:{Name:'{"text":""}'},ui:{ismenu:1}}
item replace entity @s enderchest.15 with gray_stained_glass_pane{display:{Name:'{"text":""}'},ui:{ismenu:1}}
