...
item replace entity @s enderchest.13 with popped_chorus_fruit{display:{Name:'{"text":"加速度ペレット","color": "light_purple","bold": true,"italic": false}',Lore:['{"text":"1000ブロック塗ると、","color": "gray","italic": false}','{"text":"以降ダメージを30%軽減する","color": "gray","italic": false}','{"text":"死亡時にSPゲージがリセットされる","color": "red","italic": false}']},ui:{ismenu:1}}
...
item replace entity @s enderchest.24 with netherite_scrap{display:{Name:'{"text":"強化パーツ","color":"blue","bold": false,"italic": false}',Lore:['{"text":"設置物の受けるダメージを40%減少させる","color": "gray","italic": false}']},ui:{ismenu:1}}
