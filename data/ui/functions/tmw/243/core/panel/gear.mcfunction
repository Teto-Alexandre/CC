...
item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:122005,display:{Name:'{"text":"HPアップ +1","italic": false}'},ui:{ismenu:1}}
...
item replace entity @s enderchest.10 with gray_stained_glass_pane{CustomModelData:122003,display:{Name:'{"text":"チャージ加速 +7%","italic": false}'},ui:{ismenu:1}}
...
execute if score $slot ui_temp matches 2 run data modify storage ui:gear temp.Gears append value {id:1,item:{CustomModelData:122005,display:{Name:'{"text":"HPアップ +1","italic": false}'},ui:{ismenu:1}}}
...
execute if score $slot ui_temp matches 10 run data modify storage ui:gear temp.Gears append value {id:15,item:{CustomModelData:122003,display:{Name:'{"text":"チャージ加速 +7%","italic": false}'},ui:{ismenu:1}}}
