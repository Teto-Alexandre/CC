...
execute if score $slot ui_temp matches 1 run data modify storage ui:gear temp.Gears append value {id:1,item:{CustomModelData:122005,display:{Name:'{"text":"HPアップ +1","italic": false}',Bro:'{"text":"Hp","color":"light_purple"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 2 run data modify storage ui:gear temp.Gears append value {id:16,item:{CustomModelData:122016,display:{Name:'{"text":"移動形態HP回復効率 +10%","italic": false}',Bro:'{"text":"Rr","color":"light_purple"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 3 run data modify storage ui:gear temp.Gears append value {id:2,item:{CustomModelData:122011,display:{Name:'{"text":"射撃形態移動速度 +3%","italic": false}',Bro:'{"text":"Ss","color":"green"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 4 run data modify storage ui:gear temp.Gears append value {id:3,item:{CustomModelData:122008,display:{Name:'{"text":"移動形態移動速度 +6%","italic": false}',Bro:'{"text":"Ms","color":"green"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 5 run data modify storage ui:gear temp.Gears append value {id:4,item:{CustomModelData:122002,display:{Name:'{"text":"爆発ダメージ軽減 +8%","italic": false}',Bro:'{"text":"Bp","color":"aqua"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 6 run data modify storage ui:gear temp.Gears append value {id:5,item:{CustomModelData:122009,display:{Name:'{"text":"総合ダメージ増加 +2%","italic": false}',Bro:'{"text":"Td","color":"red"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 7 run data modify storage ui:gear temp.Gears append value {id:6,item:{CustomModelData:122013,display:{Name:'{"text":"サブダメージ増加 +3%","italic": false}',Bro:'{"text":"Sd","color":"red"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 8 run data modify storage ui:gear temp.Gears append value {id:7,item:{CustomModelData:122015,display:{Name:'{"text":"対物ダメージ増加 +15%","italic": false}',Bro:'{"text":"Ad","color":"red"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 10 run data modify storage ui:gear temp.Gears append value {id:15,item:{CustomModelData:122003,display:{Name:'{"text":"チャージ加速 +5%","italic": false}',Bro:'{"text":"Cs","color":"yellow"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 11 run data modify storage ui:gear temp.Gears append value {id:8,item:{CustomModelData:122001,display:{Name:'{"text":"爆発ダメージ増加 +4%","italic": false}',Bro:'{"text":"Xd","color":"red"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 12 run data modify storage ui:gear temp.Gears append value {id:9,item:{CustomModelData:122010,display:{Name:'{"text":"リスポーン加速 +10%","italic": false}',Bro:'{"text":"Ra","color":"aqua"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 13 run data modify storage ui:gear temp.Gears append value {id:10,item:{CustomModelData:122004,display:{Name:'{"text":"死亡時SPキープ +5%","italic": false}',Bro:'{"text":"Ds","color":"aqua"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 14 run data modify storage ui:gear temp.Gears append value {id:11,item:{CustomModelData:122012,display:{Name:'{"text":"SPチャージ加速 +5%","italic": false}',Bro:'{"text":"Sa","color":"yellow"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 15 run data modify storage ui:gear temp.Gears append value {id:12,item:{CustomModelData:122006,display:{Name:'{"text":"インク回復効率 +5%","italic": false}',Bro:'{"text":"Ie","color":"yellow"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 16 run data modify storage ui:gear temp.Gears append value {id:13,item:{CustomModelData:122007,display:{Name:'{"text":"メインインク効率 +5%","italic": false}',Bro:'{"text":"Me","color":"yellow"}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 17 run data modify storage ui:gear temp.Gears append value {id:14,item:{CustomModelData:122014,display:{Name:'{"text":"サブインク効率 +5%","italic": false}',Bro:'{"text":"Se","color":"yellow"}'},ui:{ismenu:1}}}
