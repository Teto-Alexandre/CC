...
item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"HPアップ +1","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.3 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"射撃形態移動速度 +3%","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.4 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"移動形態移動速度 +3%","italic": false}'},ui:{ismenu:1}}
...
item replace entity @s enderchest.13 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"死亡時SPキープ +5%","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.14 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"SPチャージ加速 +5%","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.15 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"インク回復効率 +5%","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.16 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"メインインク効率 +5%","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.17 with gray_stained_glass_pane{CustomModelData:122000,display:{Name:'{"text":"サブインク効率 +5%","italic": false}'},ui:{ismenu:1}}
execute if score $slot ui_temp matches 2 run data modify storage ui:gear temp.Gears append value {id:1,item:{CustomModelData:122000,display:{Name:'{"text":"HPアップ +1","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 3 run data modify storage ui:gear temp.Gears append value {id:2,item:{CustomModelData:122000,display:{Name:'{"text":"射撃形態移動速度 +3%","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 4 run data modify storage ui:gear temp.Gears append value {id:3,item:{CustomModelData:122000,display:{Name:'{"text":"移動形態移動速度 +3%","italic": false}'},ui:{ismenu:1}}}
...
execute if score $slot ui_temp matches 13 run data modify storage ui:gear temp.Gears append value {id:10,item:{CustomModelData:122000,display:{Name:'{"text":"死亡時SPキープ +5%","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 14 run data modify storage ui:gear temp.Gears append value {id:11,item:{CustomModelData:122000,display:{Name:'{"text":"SPチャージ加速 +5%","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 15 run data modify storage ui:gear temp.Gears append value {id:12,item:{CustomModelData:122000,display:{Name:'{"text":"インク回復効率 +5%","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 16 run data modify storage ui:gear temp.Gears append value {id:13,item:{CustomModelData:122000,display:{Name:'{"text":"メインインク効率 +5%","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 17 run data modify storage ui:gear temp.Gears append value {id:14,item:{CustomModelData:122000,display:{Name:'{"text":"サブインク効率 +5%","italic": false}'},ui:{ismenu:1}}}
execute if score $slot ui_temp matches 2..8 run data remove storage ui:gear temp.Gears[0]
execute if score $slot ui_temp matches 10..17 run data remove storage ui:gear temp.Gears[0]

item replace entity @s enderchest.18 with gray_stained_glass_pane{display:{Name:'{"text":""}'},ui:{ismenu:1}}
