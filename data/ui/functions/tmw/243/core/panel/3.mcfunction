...
# メニュー表示
    ...
    item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:121121,display:{Name:'{"text":"[クイックアーマー]","color":"white","italic":false}',Lore:['{"text":"周囲の味方のダメージ軽減率を上げる","color":"aqua","italic":false}','{"text":"---------- data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"投擲","color":"green","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"サポート","color":"yellow","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"80","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"作動半径: ","color":"gray","italic":false},{"text":"4","color":"gold","italic":false}]','[{"text":"効果: ","color":"gray","italic":false},{"text":"Resistance(0:15)","color":"blue","italic":false}]','{"text":"-------------------------","color":"gray","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.3 with gray_stained_glass_pane{CustomModelData:121205,display:{Name:'{"text":"[スピードカバー]","color":"white","italic":false}',Lore:['{"text":"スピーダーの拡張モデルを流用した装置","color":"aqua","italic":false}','{"text":"発動中足元を自動で塗る","color":"aqua","italic":false}','{"text":"---------- data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"即時","color":"white","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"サポート","color":"yellow","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"40","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"効果時間: ","color":"gray","italic":false},{"text":"10","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','{"text":"-------------------------","color":"gray","italic":false}']},ui:{ismenu:1},HideFlags:2}
