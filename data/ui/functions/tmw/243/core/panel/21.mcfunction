...
# メニュー表示
    ...
    item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:1211011,display:{Name:'{"text":"[リモートボム]","color":"white","italic":false}',Lore:['{"text":"時限爆弾を投げる","color":"aqua","italic":false}','{"text":"Fキーで即座に起爆できる","color":"aqua","italic":false}','{"text":"---------- Q:data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"投擲","color":"green","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"アタック","color":"red","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"55","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"爆発までの時間: ","color":"gray","italic":false},{"text":"15","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','[{"text":"塗り半径: ","color":"gray","italic":false},{"text":"2.5","color":"gold","italic":false}]','[{"text":"攻撃半径: ","color":"gray","italic":false},{"text":"3.5","color":"gold","italic":false},{"text":" / ","color":"gray","italic":false},{"text":"2.5","color":"gold","italic":false}]','[{"text":"爆発ダメージ: ","color":"gray","italic":false},{"text":"6","color":"gold","italic":false},{"text":" / ","color":"gray","italic":false},{"text":"12","color":"gold","italic":false}]','{"text":"-------------------------","color":"gray","italic":false}']},ui:{ismenu:1},HideFlags:2}
    item replace entity @s enderchest.3 with gray_stained_glass_pane{CustomModelData:1211013,display:{Name:'{"text":"[カウンター]","color":"white","italic":false}',Lore:['{"text":"相手の攻撃を吸収し、撃ち返すガジェット","color":"aqua","italic":false}','{"text":"※メインウェポンの使用中も起動できる","color":"green","italic":false}','{"text":"---------- Q:data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"即時","color":"white","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"サポート","color":"yellow","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"30","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"効果時間: ","color":"gray","italic":false},{"text":"1.0","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','[{"text":"発動硬直: ","color":"gray","italic":false},{"text":"3.0","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','[{"text":"吸収成功時発動硬直リセット + ","color":"green","italic":false},{"text":"Resistance(1.5)","color":"blue","italic":false}]','{"text":"---------- F:data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"即時","color":"white","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"アタック","color":"red","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"0","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"ダメージ: ","color":"gray","italic":false},{"text":"0～...","color":"gold","italic":false}]','[{"text":"射程: ","color":"gray","italic":false},{"text":"5～...","color":"gold","italic":false}]','[{"text":"弾速: ","color":"gray","italic":false},{"text":"30～...","color":"gold","italic":false}]','[{"text":"弾サイズ: ","color":"gray","italic":false},{"text":"1～...3","color":"gold","italic":false}]','[{"text":"足元塗り: ","color":"gray","italic":false},{"text":"Medium","color":"yellow","italic":false}]','[{"text":"硬直: ","color":"gray","italic":false},{"text":"0","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','{"text":"-------------------------","color":"gray","italic":false}']},ui:{ismenu:1},HideFlags:2}
    ...
    item replace entity @s enderchest.26 with black_stained_glass_pane{display:{Name:'{"text":"戻る","color":"green","italic":false}'},ui:{ismenu:1}}
