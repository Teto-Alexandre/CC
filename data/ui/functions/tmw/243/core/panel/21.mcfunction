...
# メニュー表示
    ...
    item replace entity @s enderchest.3 with apple{CustomModelData:121117,display:{Name:'{"text":"[カウンター]","color":"white","italic":false}',Lore:['{"text":"相手の攻撃を吸収し、撃ち返すガジェット","color":"aqua","italic":false}','{"text":"※メインウェポンの使用中も起動できる","color":"green","italic":false}','{"text":"---------- Q:data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"即時","color":"white","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"サポート","color":"yellow","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"30","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"効果時間: ","color":"gray","italic":false},{"text":"0.5","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','{"text":"---------- F:data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"武装","color":"red","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"アタック","color":"red","italic":false}]','[{"text":"インク消費量: ","color":"gray","italic":false},{"text":"0","color":"gold","italic":false},{"text":" %","color":"gray","italic":false}]','[{"text":"直撃ダメージ: ","color":"gray","italic":false},{"text":"0～...","color":"gold","italic":false},{"text":" x ","color":"gray","italic":false},{"text":"1～9","color":"gold","italic":false}]','[{"text":"散布界: ","color":"gray","italic":false},{"text":"15","color":"gold","italic":false},{"text":" °","color":"gray","italic":false}]','[{"text":"射程: ","color":"gray","italic":false},{"text":"7.5","color":"gold","italic":false}]','[{"text":"足元塗り: ","color":"gray","italic":false},{"text":"Medium","color":"yellow","italic":false}]','[{"text":"硬直: ","color":"gray","italic":false},{"text":"0","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','{"text":"-------------------------","color":"gray","italic":false}']},ui:{ismenu:1},HideFlags:2}
