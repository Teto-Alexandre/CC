...
# メニュー表示
    ...
    item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:1211011,display:{Name:'{"text":"[リモートボム]","color":"white","italic":false}',Lore:['{"text":"時限爆弾を投げる","color":"aqua","italic":false}','{"text":"Fキーで即座に起爆できる","color":"aqua","italic":false}']},ui:{ismenu:1},HideFlags:2}
