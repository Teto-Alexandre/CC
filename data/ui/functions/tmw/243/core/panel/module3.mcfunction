...
item replace entity @s enderchest.15 with leather_chestplate{display:{Name:'{"text":"装備せよ","color":"green","italic":false}',Lore:['[{"text":"革のチェストプレートを装備する","color":"gray","italic":false}]','[{"text":"防御力は1点につきダメージを5%カットする","color":"gray","italic":false}]','[{"text":"移動形態中の効果はない","color":"gray","italic":false}]','[{"text":"*何か革った？*","color":"blue","italic":false}]']},ui:{ismenu:1},HideFlags:255}
