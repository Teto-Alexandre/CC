...
execute if score $slot ui_temp matches 3 run tag @s[tag=tmw_237_notitle] add ui_temp_this
execute if score $slot ui_temp matches 3 run tag @s[tag=!tmw_237_notitle] add tmw_237_notitle
execute if score $slot ui_temp matches 3 run tag @s[tag=ui_temp_this] remove tmw_237_notitle
execute if score $slot ui_temp matches 3 run tag @s[tag=ui_temp_this] remove ui_temp_this
execute if score $slot ui_temp matches 4 run tag @s[tag=tmw_237_nolaser] add ui_temp_this
execute if score $slot ui_temp matches 4 run tag @s[tag=!tmw_237_nolaser] add tmw_237_nolaser
execute if score $slot ui_temp matches 4 run tag @s[tag=ui_temp_this] remove tmw_237_nolaser
execute if score $slot ui_temp matches 4 run tag @s[tag=ui_temp_this] remove ui_temp_this
execute if score $slot ui_temp matches 5 run tag @s[tag=tmw_237_noboost] add ui_temp_this
execute if score $slot ui_temp matches 5 run tag @s[tag=!tmw_237_noboost] add tmw_237_noboost
execute if score $slot ui_temp matches 5 run tag @s[tag=ui_temp_this] remove tmw_237_noboost
execute if score $slot ui_temp matches 5 run tag @s[tag=ui_temp_this] remove ui_temp_this
execute if score $slot ui_temp matches 6 run tag @s[tag=tmw_237_noresparticle] add ui_temp_this
execute if score $slot ui_temp matches 6 run tag @s[tag=!tmw_237_noresparticle] add tmw_237_noresparticle
execute if score $slot ui_temp matches 6 run tag @s[tag=ui_temp_this] remove tmw_237_noresparticle
...
execute if entity @s[tag=tmw_237_notitle] run item replace entity @s enderchest.3 with red_stained_glass_pane{display:{Name:'{"text":"HUD: 非表示","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=!tmw_237_notitle] run item replace entity @s enderchest.3 with lime_stained_glass_pane{display:{Name:'{"text":"HUD: 表示","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=tmw_237_nolaser] run item replace entity @s enderchest.4 with red_stained_glass_pane{display:{Name:'{"text":"狙撃射線: 非表示","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=!tmw_237_nolaser] run item replace entity @s enderchest.4 with lime_stained_glass_pane{display:{Name:'{"text":"狙撃射線: 表示","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=tmw_237_noboost] run item replace entity @s enderchest.5 with red_stained_glass_pane{display:{Name:'{"text":"スーパーブースト: 無効","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=!tmw_237_noboost] run item replace entity @s enderchest.5 with lime_stained_glass_pane{display:{Name:'{"text":"スーパーブースト: 有効","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=tmw_237_noresparticle] run item replace entity @s enderchest.6 with red_stained_glass_pane{display:{Name:'{"text":"無敵時間パーティクル表示: 無効","italic": false}'},ui:{ismenu:1}}
execute if entity @s[tag=!tmw_237_noresparticle] run item replace entity @s enderchest.6 with lime_stained_glass_pane{display:{Name:'{"text":"無敵時間パーティクル表示: 有効","italic": false}'},ui:{ismenu:1}}
