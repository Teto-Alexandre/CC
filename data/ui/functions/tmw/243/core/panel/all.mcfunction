...
execute if score $slot ui_temp matches 13 run function ui:tmw/243/core/stats
...
item replace entity @s enderchest.13 with book{display:{Name:'{"text":"戦績確認","color": "gold","italic": false}'},ui:{ismenu:1}}
