...
# メニュー表示
    ...
    item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:121464,display:{Name:'{"text":"[キューインキ]","color":"white","italic":false}',Lore:['{"text":"相手のインクを吸引できる装備","color":"aqua","italic":false}','{"text":"吸収したインクは最後にまとめて発射される","color":"aqua","italic":false}','{"text":"相手を気流に巻き込むとインクを吸い取り、デバフを与える","color":"aqua","italic":false}','{"text":"吸引途中でも発射できる","color":"blue","italic":false}','{"text":"---------- data ----------","color":"gray","italic":false}','[{"text":"タイプ: ","color":"gray","italic":false},{"text":"武装","color":"red","italic":false},{"text":" - ","color":"gray","italic":false},{"text":"アタック","color":"red","italic":false}]','[{"text":"起動遅延: ","color":"gray","italic":false},{"text":"0.5","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','[{"text":"効果時間: ","color":"gray","italic":false},{"text":"6","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','[{"text":"直撃ダメージ: ","color":"gray","italic":false},{"text":"10～...","color":"gold","italic":false}]','[{"text":"塗り半径: ","color":"gray","italic":false},{"text":"5","color":"gold","italic":false}]','[{"text":"攻撃半径: ","color":"gray","italic":false},{"text":"5","color":"gold","italic":false}]','[{"text":"爆発ダメージ: ","color":"gray","italic":false},{"text":"6","color":"gold","italic":false}]','[{"text":"射程: ","color":"gray","italic":false},{"text":"50","color":"gold","italic":false}]','[{"text":"足元塗り: ","color":"gray","italic":false},{"text":"None","color":"aqua","bold": false,"italic":false}]','[{"text":"硬直: ","color":"gray","italic":false},{"text":"0.75","color":"gold","italic":false},{"text":" sec","color":"gray","italic":false}]','{"text":"-------------------------","color":"gray","italic":false}']},ui:{ismenu:1},HideFlags:2}
