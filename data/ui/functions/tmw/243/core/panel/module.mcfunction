...
execute if entity @s[tag=adv40] run item replace entity @s enderchest.13 with cookie{CustomModelData:170002,display:{Name:'{"text":"アップビート","color": "red","bold": false,"italic": false}',Lore:['{"text":"攻撃力が10%上がる","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[tag=adv45] run item replace entity @s enderchest.14 with cookie{CustomModelData:170006,display:{Name:'{"text":"グリッターエッセンス","color": "gold","bold": false,"italic": false}',Lore:['{"text":"攻撃対象を発光させる","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[tag=adv80] run item replace entity @s enderchest.15 with totem_of_undying{display:{Name:'{"text":"半死のトーテム","color": "yellow","bold": false,"italic": false}',Lore:['{"text":"死ぬたびに一度だけ","color": "gray","italic": false}','{"text":"攻撃を無効化するシールドを張る","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[tag=adv55] run item replace entity @s enderchest.16 with ink_sac{display:{Name:'{"text":"足袋","color": "dark_aqua","bold": true,"italic": false}',Lore:['{"text":"移動形態の際に飛沫が散らなくなる","color": "gray","italic": false}']},ui:{ismenu:1}}
...
execute if entity @s[tag=adv40] if score $slot ui_temp matches 13 run scoreboard players set @s module 11
execute if entity @s[tag=adv45] if score $slot ui_temp matches 14 run scoreboard players set @s module 12
execute if entity @s[tag=adv80] if score $slot ui_temp matches 15 run scoreboard players set @s module 13
execute if entity @s[tag=adv55] if score $slot ui_temp matches 16 run scoreboard players set @s module 14
...
execute if entity @s[tag=adv60] run item replace entity @s enderchest.21 with iron_boots{HideFlags:2,display:{Name:'{"text":"スリッパ","color": "#66cc00","bold": true,"italic": false}',Lore:['{"text":"移動速度が10%上がる","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[tag=adv35] run item replace entity @s enderchest.22 with heart_of_the_sea{display:{Name:'{"text":"冷たくなった心臓","color": "aqua","bold": false,"italic": false}',Lore:['{"text":"最大体力が20%上がる","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[tag=adv50] run item replace entity @s enderchest.23 with elytra{display:{Name:'{"text":"アンチマーカーシステム","color": "dark_purple","bold": true,"italic": false}',Lore:['{"text":"発光の持続時間が半減する","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[tag=adv75] run item replace entity @s enderchest.24 with spyglass{display:{Name:'{"text":"13スコープ","color": "#9966ff","bold": false,"italic": false}',Lore:['{"text":"チャージ完了時の光を消す","color": "gray","italic": false}']},ui:{ismenu:1}}
execute if entity @s[advancements={ui:complete/root=true}] run item replace entity @s enderchest.25 with gold_block{display:{Name:'{"text":"物語の終わり","color": "#ffcc66","bold": true,"italic": false}',Lore:['{"text":"攻撃時に15%の確率でダメージ2倍","color": "gray","italic": false}']},ui:{ismenu:1}}
...
execute if entity @s[tag=adv60] unless score $slot ui_temp matches -1 unless score $slot ui_temp matches 21 run attribute @s generic.movement_speed modifier remove 2a93cf3d-b14d-4538-87cc-5fd0119eac2c
...
execute if entity @s[tag=adv35] unless score $slot ui_temp matches -1 unless score $slot ui_temp matches 22 run attribute @s generic.max_health modifier remove 2a93cf3d-b14d-4538-87cc-5fd0119eac2d
...
execute if entity @s[advancements={ui:complete/root=true}] if score $slot ui_temp matches 25 run scoreboard players set @s module 21
