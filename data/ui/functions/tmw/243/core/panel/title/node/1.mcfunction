...
item replace entity @s enderchest.1 with gray_stained_glass_pane{CustomModelData:123001,display:{Name:'{"text":"インク残量（デジタル表記３桁）","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.2 with gray_stained_glass_pane{CustomModelData:123002,display:{Name:'{"text":"ＳＰゲージ（デジタル表記３桁）","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.3 with gray_stained_glass_pane{CustomModelData:123003,display:{Name:'{"text":"インクゲージ（１０ブロック）","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.4 with gray_stained_glass_pane{CustomModelData:123004,display:{Name:'{"text":"ＳＰゲージ（１０ブロック）","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.5 with gray_stained_glass_pane{CustomModelData:123005,display:{Name:'{"text":"全角スペース","italic": false}'},ui:{ismenu:1}}
...
item replace entity @s enderchest.7 with gray_stained_glass_pane{CustomModelData:123007,display:{Name:'{"text":"ID:7","italic": false}'},ui:{ismenu:1}}
...
item replace entity @s enderchest.10 with gray_stained_glass_pane{CustomModelData:123008,display:{Name:'{"text":"ID:8","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.11 with gray_stained_glass_pane{CustomModelData:123009,display:{Name:'{"text":"ID:9","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.12 with gray_stained_glass_pane{CustomModelData:123010,display:{Name:'{"text":"ID:10","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.13 with gray_stained_glass_pane{CustomModelData:123011,display:{Name:'{"text":"ID:11","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.14 with gray_stained_glass_pane{CustomModelData:123012,display:{Name:'{"text":"ID:12","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.15 with gray_stained_glass_pane{CustomModelData:123013,display:{Name:'{"text":"ID:13","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.16 with gray_stained_glass_pane{CustomModelData:123014,display:{Name:'{"text":"ID:14","italic": false}'},ui:{ismenu:1}}
...
item replace entity @s enderchest.19 with gray_stained_glass_pane{CustomModelData:123015,display:{Name:'{"text":"ID:15","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.20 with gray_stained_glass_pane{CustomModelData:123016,display:{Name:'{"text":"ID:16","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.21 with gray_stained_glass_pane{CustomModelData:123017,display:{Name:'{"text":"ID:17","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.22 with gray_stained_glass_pane{CustomModelData:123018,display:{Name:'{"text":"ID:18","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.23 with gray_stained_glass_pane{CustomModelData:123019,display:{Name:'{"text":"ID:19","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.24 with gray_stained_glass_pane{CustomModelData:123020,display:{Name:'{"text":"ID:20","italic": false}'},ui:{ismenu:1}}
item replace entity @s enderchest.25 with gray_stained_glass_pane{CustomModelData:123021,display:{Name:'{"text":"ID:21","italic": false}'},ui:{ismenu:1}}
...
execute if score $slot ui_temp matches 7 run data modify storage ui:text_board temp.node set value {ID:7,CustomModelData:123007}
execute if score $slot ui_temp matches 10 run data modify storage ui:text_board temp.node set value {ID:8,CustomModelData:123008}
execute if score $slot ui_temp matches 11 run data modify storage ui:text_board temp.node set value {ID:9,CustomModelData:123009}
execute if score $slot ui_temp matches 12 run data modify storage ui:text_board temp.node set value {ID:10,CustomModelData:123010}
execute if score $slot ui_temp matches 13 run data modify storage ui:text_board temp.node set value {ID:11,CustomModelData:123011}
...
execute if score $slot ui_temp matches 1..26 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 0.8 2 0
execute if score $slot ui_temp matches 1..26 run scoreboard players set @s title_node 0
