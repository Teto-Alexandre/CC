...
execute if score $slot ui_temp matches 1..26 unless score $slot ui_temp matches 1 run playsound entity.experience_orb.pickup player @a ~ ~ ~ 0.8 2 0
execute if score $slot ui_temp matches 1..26 unless score $slot ui_temp matches 1 run scoreboard players set @s title_node 0
