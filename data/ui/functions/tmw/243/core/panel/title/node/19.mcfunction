...
execute if score $slot ui_temp matches 1 run data modify storage ui:text_board temp.node set value {ID:19,CustomModelData:123021,Data:1}

execute if score $slot ui_temp matches 3 run data modify storage ui:text_board temp.node set value {ID:19,CustomModelData:123021,Data:2}
execute if score $slot ui_temp matches 4 run data modify storage ui:text_board temp.node set value {ID:19,CustomModelData:123021,Data:3}
execute if score $slot ui_temp matches 5 run data modify storage ui:text_board temp.node set value {ID:19,CustomModelData:123021,Data:4}
