...
#
    ...
    execute if score $page ui_temp matches 3 if score $qf ui_temp matches 3 run function ui:tmw/243/core/page/13alt
    ...
    execute if score $page ui_temp matches 13 if score $qf ui_temp matches 1 run function ui:tmw/243/core/page/13
    ...
    execute if score $page ui_temp matches 13 if score $qf ui_temp matches 3 run function ui:tmw/243/core/page/13