...
#
    execute if entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] run scoreboard players set @s ui_use1 0
    execute if entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] run scoreboard players set @s ui_use2 0
