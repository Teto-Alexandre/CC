...
execute as @e[tag=ui_proj,tag=tmw_237] if score @s ui_team = $team ui_temp run tag @s add ui_temp_team
...
execute as @e[distance=0.01..9,tag=!ui_temp_team,tag=ui_proj,tag=tmw_237] run function ui:tmw/237/activator/time/464/marker.1
...
tag @e[tag=ui_proj,tag=tmw_237,tag=ui_temp_team] remove ui_temp_team
