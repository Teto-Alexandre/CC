...
data modify storage ui_temp: Unpower set value {Name:'{"text":"ブーメラン","color":"gray"}',Speed:30,RangeType:1,Range:200,FlyParticle:107,EndParticle:4,Damage:100}
function ui:tmw/237/misc/unpower
playsound entity.firework_rocket.blast player @a ~ ~ ~ 1.6 1.2 0