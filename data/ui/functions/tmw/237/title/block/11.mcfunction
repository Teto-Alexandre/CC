...
scoreboard players remove $text.temp ui_temp 40
scoreboard players operation $text.temp ui_temp *= #100 ui_num
execute unless score @s module matches 1 run scoreboard players operation $text.temp ui_temp /= #240 ui_num
execute if score @s module matches 1 run scoreboard players operation $text.temp ui_temp /= #140 ui_num
scoreboard players operation $text.temp ui_temp < #100 ui_num
scoreboard players operation $text.temp ui_temp > #0 ui_num

execute if score @s module matches 31 run scoreboard players set $mod ui_calc1 101
execute if score @s module matches 31 run function ui:common/rand
execute if score @s module matches 31 run scoreboard players operation $text.temp ui_temp = $rand ui_calc1
