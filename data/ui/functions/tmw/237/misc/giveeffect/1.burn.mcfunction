...
execute if data storage ui:temp _.effect{ShowParticles:0b} run data modify storage ui:temp _.input.hide_particles set value 1b
execute unless data storage ui:temp _.effect{ShowParticles:0b} run data modify storage ui:temp _.input.hide_particles set value 0b
