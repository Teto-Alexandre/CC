# ダメージ増加
    ...
    execute if entity @s[tag=!tmw_237_proj_first] run scoreboard players operation @s ui_expdmg += $dmg.temp ui_temp
    execute if entity @s[tag=!tmw_237_proj_first] run scoreboard players operation @s ui_expdmg_n += $dmg.temp ui_temp
    execute if entity @s[tag=!tmw_237_proj_first] run scoreboard players operation @s ui_expdmg_f += $dmg.temp ui_temp
