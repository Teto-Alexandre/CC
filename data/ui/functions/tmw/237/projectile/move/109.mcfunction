...
#
    ...
    execute at @s[tag=!tmw237_reflected] unless block ~ ~0.75 ~ #ui:nocol store success score #success ui_temp run tag @s add tmw237_reflected.up
    execute at @s[tag=!tmw237_reflected] unless block ~ ~-0.75 ~ #ui:nocol store success score #success ui_temp run tag @s add tmw237_reflected.down
    execute at @s[tag=!tmw237_reflected] unless block ~0.75 ~ ~ #ui:nocol store success score #success ui_temp run tag @s add tmw237_reflected.east
    execute at @s[tag=!tmw237_reflected] unless block ~-0.75 ~ ~ #ui:nocol store success score #success ui_temp run tag @s add tmw237_reflected.west
    execute at @s[tag=!tmw237_reflected] unless block ~ ~ ~0.75 #ui:nocol store success score #success ui_temp run tag @s add tmw237_reflected.south
    execute at @s[tag=!tmw237_reflected] unless block ~ ~ ~-0.75 #ui:nocol store success score #success ui_temp run tag @s add tmw237_reflected.north
