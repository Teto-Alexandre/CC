...
# 初期衝撃波
    ...
    execute if entity @s[tag=!tmw_237_proj_first] positioned ^ ^ ^0 run particle enchanted_hit ~ ~ ~ 0.2 0.2 0.2 0.5 1 force
    ...
    execute if entity @s[tag=!tmw_237_proj_first] positioned ^ ^ ^3 run particle enchanted_hit ~ ~ ~ 0.2 0.2 0.2 0.5 1 force
    ...
    execute if entity @s[tag=!tmw_237_proj_first] positioned ^ ^ ^4 run particle enchanted_hit ~ ~ ~ 0.2 0.2 0.2 0.5 1 force
    ...
    execute if entity @s[tag=!tmw_237_proj_first] positioned ^ ^ ^5 run particle enchanted_hit ~ ~ ~ 0.2 0.2 0.2 0.5 1 force
