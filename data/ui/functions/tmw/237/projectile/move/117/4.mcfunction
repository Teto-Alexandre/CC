execute if entity @s[tag=!tmw_237_proj_first] run data modify entity @s ArmorItems[3] set value {id:carrot_on_a_stick,Count:1b,tag:{CustomModelData:110879}}
...
particle dust 0.5 1 0.5 0.8 ~ ~ ~ 0 0 0 0 1 force
