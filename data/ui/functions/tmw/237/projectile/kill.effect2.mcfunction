...
# ヒットパーティクル
    # サイズ別通常爆発
        ...
        execute if score @s ui_hpart matches 10..18 run function ui:tmw/237/projectile/killeffect/10
        execute if score @s ui_hpart matches 19 run function ui:tmw/237/projectile/killeffect/19
