...
# ヒットパーティクル
    # サイズ別通常爆発
        ...
        execute if score @s ui_hpart matches -61 run function ui:tmw/237/projectile/killeffect/6.2
        execute if score @s ui_hpart matches -62 run function ui:tmw/237/projectile/killeffect/6.3
