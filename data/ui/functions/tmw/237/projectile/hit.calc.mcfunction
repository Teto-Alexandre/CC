...
execute if data storage ui:gun temp3.BulletData.hitbox_y store result score #hitbox_y ui_temp run data get storage ui:gun temp3.BulletData.hitbox_y 100
