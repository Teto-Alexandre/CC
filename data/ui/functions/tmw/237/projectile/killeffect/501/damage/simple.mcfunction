#$say $(command)
execute unless data storage ui:gun temp3.BulletData.Explodion.damage[0] run data modify storage ui:temp temp.explodion.damage set from storage ui:gun temp3.BulletData.Explodion.damage
