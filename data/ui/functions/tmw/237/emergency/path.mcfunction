...
execute if score $temp ui_temp matches 3 run tellraw @s[tag=tmw_237_noboost] {"text":"ブーストを有効化します"}
execute if score $temp ui_temp matches 3 run tag @s[tag=tmw_237_noboost] add ui_temp_this
execute if score $temp ui_temp matches 3 run tellraw @s[tag=!tmw_237_noboost] {"text":"ブーストを無効化します"}
execute if score $temp ui_temp matches 3 run tag @s[tag=!tmw_237_noboost] add tmw_237_noboost
execute if score $temp ui_temp matches 3 run tag @s[tag=ui_temp_this] remove tmw_237_noboost
execute if score $temp ui_temp matches 3 run tag @s[tag=ui_temp_this] remove ui_temp_this