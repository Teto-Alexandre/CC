...
execute if score $temp ui_temp matches 0..8 if entity @s[advancements={ui:add/misc/self_destruct=false}] run advancement grant @s only ui:add/misc/self_destruct
