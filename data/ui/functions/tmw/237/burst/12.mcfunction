...
# 離すと書き込み
    execute unless score $multibullet ui_temp matches 1.. if score $ishold ui_temp matches 2.. if score $cooltime ui_temp matches 0 as @s[scores={ui_use1=1..}] run function ui:tmw/237/burst/8_2
    execute if score $multibullet ui_temp matches 1.. if score $cooltime ui_temp matches 0 as @s[scores={ui_use1=1..}] run function ui:tmw/237/burst/8_2
