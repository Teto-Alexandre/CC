...
execute if score $subtype ui_temp matches 463 run data modify storage ui:gun temp set value {Name:'{"text":"リフレクトレーザー","color":"gold"}',TimeUse:150,ShotType:1,ShotCT:1,BurstCT:12,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:35,SpeedPlus:0,RangeType:1,Range:50,FlyParticle:109,EndParticle:119,Damage:140,MultiShot:1,ShotFootStep:0,Sound:4,Pierce:1b}
