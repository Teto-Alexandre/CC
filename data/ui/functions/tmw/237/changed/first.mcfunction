...
execute if score $subtype ui_temp matches 464 run data modify storage ui:gun temp set value {Name:'{"text":"キューインキ","color":"gold"}',TimeUse:500,ShotType:1,ShotCT:1,BurstCT:15,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:35,SpeedPlus:15,RangeType:2,Range:50,FlyParticle:116,EndParticle:10,Damage:100,MultiShot:1,ShotFootStep:0,Sound:4,Pierce:1b}
...
execute if score $sptype ui_temp matches 464 run data modify storage ui:gun temp set value {Name:'{"text":"キューインキ","color":"gold"}',TimeUse:500,ShotType:1,ShotCT:1,BurstCT:15,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:35,SpeedPlus:15,RangeType:2,Range:50,FlyParticle:116,EndParticle:10,Damage:100,MultiShot:1,ShotFootStep:0,Sound:4,Pierce:1b}
