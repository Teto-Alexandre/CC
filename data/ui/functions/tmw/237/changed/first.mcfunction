...
execute if score $subtype ui_temp matches 456 run data modify storage ui:gun temp set value {Name:'{"text":"バウンシーボム","color":"gold"}',TimeUse:75,ShotType:1,ShotCT:8,BurstCT:16,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:20,SpeedPlus:0,RangeType:2,Range:80,FlyParticle:104,EndParticle:204,Damage:200,MultiShot:1,ShotFootStep:1,Sound:4}
...
execute if score $sptype ui_temp matches 456 run data modify storage ui:gun temp set value {Name:'{"text":"バウンシーボム","color":"gold"}',TimeUse:75,ShotType:1,ShotCT:8,BurstCT:16,Spread:0,AirSpread:0,SpreadType:1,AirSpreadType:1,Speed:20,SpeedPlus:0,RangeType:2,Range:80,FlyParticle:104,EndParticle:204,Damage:200,MultiShot:1,ShotFootStep:1,Sound:4}
