...
# チャージ数に応じて強化
    ...
    execute if score $burst_alt.id ui_temp matches 51 if score $burst_alt ui_temp matches 21.. run scoreboard players add $speed ui_temp 5
    ...
    execute if score $burst_alt.id ui_temp matches 51 if score $burst_alt ui_temp matches 41.. run scoreboard players add $speed ui_temp 5
    ...
    execute if score $burst_alt.id ui_temp matches 51 if score $burst_alt ui_temp matches 60.. run scoreboard players add $speed ui_temp 5
