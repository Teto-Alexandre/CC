...
#
    execute if score $damage ui_temp matches 0 run function ui:tmw/237/attack/shot/burst8/201/damage
    execute if score $range ui_temp matches 0 run function ui:tmw/237/attack/shot/burst8/201/range
    execute if score $speed ui_temp matches 0 run function ui:tmw/237/attack/shot/burst8/201/speed
    execute if score $speed.plus ui_temp matches 0 run function ui:tmw/237/attack/shot/burst8/201/speed_plus
    execute if score $multishot ui_temp matches 0 run function ui:tmw/237/attack/shot/burst8/201/multishot
