...
#
scoreboard players operation $sound ui_temp = $max ui_temp
scoreboard players operation $sound ui_temp += $min ui_temp
scoreboard players operation $sound ui_temp /= #100 ui_num
execute if score $burst_percent ui_temp matches 100.. run scoreboard players operation $sound ui_temp = $fc ui_temp