# アルトサイクル
    ...
    execute if score $burst_alt ui_temp matches 21.. run scoreboard players add $damage ui_temp 120
    ...
    execute if score $burst_alt ui_temp matches 11.. run scoreboard players remove $spread ui_temp 40
    execute if score $burst_alt ui_temp matches 21.. run scoreboard players remove $spread ui_temp 60
