...
#
    ...
    execute if score $bursttype ui_temp matches 12 if score $multibullet ui_temp matches 1.. run scoreboard players set $temp ui_temp 1
    execute if score $bursttype ui_temp matches 12 if score $multibullet ui_temp matches 1.. if score @s ui_st2 > $chargekeep ui_temp run function ui:tmw/237/constant/charge_cancel2
