...
# エフェクト
    execute if score $team ui_temp matches 1 unless score @s ui_tmw237_sprint_particle matches 1.. run particle block light_blue_concrete ~ ~1.2 ~ 0.1 0.1 0.1 0 2 normal
    execute if score $team ui_temp matches 2 unless score @s ui_tmw237_sprint_particle matches 1.. run particle block pink_concrete ~ ~1.2 ~ 0.1 0.1 0.1 0 2 normal
    execute if score $team ui_temp matches 3 unless score @s ui_tmw237_sprint_particle matches 1.. run particle block yellow_concrete ~ ~1.2 ~ 0.1 0.1 0.1 0 2 normal
    execute if score $team ui_temp matches 4 unless score @s ui_tmw237_sprint_particle matches 1.. run particle block lime_concrete ~ ~1.2 ~ 0.1 0.1 0.1 0 2 normal
