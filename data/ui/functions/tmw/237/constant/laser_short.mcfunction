...
# 弾を出す
    ...
    scoreboard players set $c.proj.speed ui_temp 150
    scoreboard players set $c.proj.range ui_temp 15
...
execute as @e[tag=tmw_237_Punit_unpower] at @s facing entity @e[tag=ui_marker,limit=1] feet positioned ~ ~1.5 ~ run teleport @s ^ ^ ^2 ~ ~
