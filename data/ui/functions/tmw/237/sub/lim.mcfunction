...
# クイック - ペアサブ発動
execute if score $quick_use ui_temp matches 1 if score $success ui_temp matches 0 if score $subtype ui_temp matches 1001.. if score $sptype ui_temp matches 1001.. if score $ink ui_temp < $ink.sub ui_temp if score $cooltime ui_temp matches 0 run function ui:tmw/237/sub/fail_lim
