...
# 処理終了
    ...
    execute as @s[tag=ui_237_sub_stop,tag=!ui_237_sub_first,tag=ui_237_thrown_by_module41] run effect give @e[tag=ui_temp_obj,tag=tmw_237_sub_123_1,limit=1,sort=nearest] resistance infinite 1 true
