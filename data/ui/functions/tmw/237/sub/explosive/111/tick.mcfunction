...
# 処理終了
    ...
    execute if score @s ui_is matches 101.. run scoreboard players operation $time ui_temp %= #6 ui_num
    execute if score @s ui_is matches 1..100 run scoreboard players operation $time ui_temp %= #8 ui_num
    execute as @s[tag=ui_237_sub_stop] if score $time ui_temp matches 0 run scoreboard players remove @s ui_is 3
    ...
    execute as @s[tag=ui_237_sub_stop,tag=!ui_237_sub_first,tag=ui_237_thrown_by_module41] run effect give @e[tag=ui_temp_obj,tag=tmw_237_sub_111_1,limit=1,sort=nearest] resistance infinite 1 true
...
# 射撃
    ...
    execute if entity @s[tag=ui_237_sub_stop] if score @s ui_is matches 201.. if score $time ui_temp matches 0 rotated ~ -60 positioned ^ ^ ^-0.5 run function ui:tmw/237/sub/explosive/111/rain
    execute if entity @s[tag=ui_237_sub_stop] if score @s ui_is matches 201.. if score $time ui_temp matches 2 rotated ~180 -60 positioned ^ ^ ^-0.5 run function ui:tmw/237/sub/explosive/111/rain
    execute if entity @s[tag=ui_237_sub_stop] if score @s ui_is matches 101..200 if score $time ui_temp matches 0 rotated ~ -60 positioned ^ ^ ^-0.5 run function ui:tmw/237/sub/explosive/111/rain
    execute if entity @s[tag=ui_237_sub_stop] if score @s ui_is matches 101..200 if score $time ui_temp matches 3 rotated ~180 -60 positioned ^ ^ ^-0.5 run function ui:tmw/237/sub/explosive/111/rain
    execute if entity @s[tag=ui_237_sub_stop] if score @s ui_is matches 1..100 if score $time ui_temp matches 0 rotated ~ -60 positioned ^ ^ ^-0.5 run function ui:tmw/237/sub/explosive/111/rain
    execute if entity @s[tag=ui_237_sub_stop] if score @s ui_is matches 1..100 if score $time ui_temp matches 4 rotated ~180 -60 positioned ^ ^ ^-0.5 run function ui:tmw/237/sub/explosive/111/rain
