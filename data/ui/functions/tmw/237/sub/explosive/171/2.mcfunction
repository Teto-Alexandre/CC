...
execute store result score $temp ui_temp at @e[tag=ui_temp_obj,tag=tmw_237_sub_171_2_1] run fill ~ ~-10 ~ ~ ~20 ~ pink_wool replace #ui:wools
scoreboard players operation $paint ui_temp = $temp ui_temp
scoreboard players set $temp ui_temp 0
execute store result score $temp ui_temp at @e[tag=ui_temp_obj,tag=tmw_237_sub_171_2_2] run fill ~ ~-10 ~ ~ ~20 ~ pink_wool replace #ui:wools
scoreboard players operation $paint ui_temp += $temp ui_temp
scoreboard players set $temp ui_temp 0
execute store result score $temp ui_temp at @e[tag=ui_temp_obj,tag=tmw_237_sub_171_3_1] run fill ~ ~-10 ~ ~ ~20 ~ pink_wool replace #ui:wools
scoreboard players operation $paint ui_temp += $temp ui_temp
scoreboard players set $temp ui_temp 0
execute store result score $temp ui_temp at @e[tag=ui_temp_obj,tag=tmw_237_sub_171_3_2] run fill ~ ~-10 ~ ~ ~20 ~ pink_wool replace #ui:wools
scoreboard players operation $paint ui_temp += $temp ui_temp
