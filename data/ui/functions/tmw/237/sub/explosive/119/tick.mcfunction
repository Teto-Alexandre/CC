...
# 常時実行
    ...
    execute as @e[predicate=ui:load_unhurtable,tag=!ui_resistance,nbt=!{Invulnerable:1b},distance=..3,tag=!tds_nolog,tag=!module19] unless score @s ui_team = $temp ui_temp run effect give @s glowing 1 0 false
