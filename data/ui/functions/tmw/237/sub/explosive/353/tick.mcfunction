...
# 常時実行
    execute if score @s ui_is matches 30.. run tag @s add ui_237_sub_explode
...
# 加速
    ...
    execute if score @s ui_is matches 3.. rotated ~ 30 run function ui:template/accelerator/1.5
