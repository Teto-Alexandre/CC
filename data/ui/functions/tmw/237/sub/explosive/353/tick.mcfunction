...
#
    ...
    execute as @s[tag=!ui_237_sub_first] run ride @p mount @e[tag=ui_temp_this,tag=tmw_237_sub_353_1,sort=nearest,limit=1]
...
# 反射
    ...
    execute as @e[tag=ui_temp_obj,tag=!ui_237_sub_explode,tag=tmw_237_sub_353_1] at @s rotated as @p run teleport @s ~ ~0.5 ~ ~ 0
