...
# ダメージを与える
    #execute if score $team ui_temp matches 1 run data modify storage ui:temp Name set value '{"text":"インクタレット","color":"aqua"}'
    #execute if score $team ui_temp matches 2 run data modify storage ui:temp Name set value '{"text":"インクタレット","color":"light_purple"}'
    #execute if score $team ui_temp matches 3 run data modify storage ui:temp Name set value '{"text":"インクタレット","color":"yellow"}'
    #execute if score $team ui_temp matches 4 run data modify storage ui:temp Name set value '{"text":"インクタレット","color":"green"}'
