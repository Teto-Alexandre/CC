...
# 常時実行
    ...
    execute if score @s ui_uses matches 2 run scoreboard players set @s ui_is 400
...
# 処理終了
    ...
    execute as @s[tag=ui_237_sub_stop] if score $time ui_temp matches 0 run scoreboard players remove @s ui_is 30
