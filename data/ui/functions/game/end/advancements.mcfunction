...
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"冷たくなった心臓","color": "aqua","bold": false},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"アップビート","color": "red","bold": false},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"グリッターエッセンス","color": "gold","bold": false},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"アンチマーカーシステム","color": "dark_purple","bold": true},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"足袋","color": "dark_aqua","bold": true},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"スリッパ","color": "#66cc00","bold": true},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"深淵の呼び声","color": "#0066cc","bold": true},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"エコバッグ","color": "#999900","bold": true},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"13スコープ","color": "#9966ff","bold": false},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
#tellraw @s [{"text":"Module","color": "gray"},{"text":"> ","color": "gold"},{"text":"[","color": "white"},{"text":"半死のトーテム","color": "yellow","bold": false},{"text":"]","color": "white"},{"text":"を獲得しました","color": "gray"}]
tag @s add adv35
tag @s add adv40
tag @s add adv45
tag @s add adv50
...
execute if entity @a[scores={ui_r_game=1..}] unless entity @s[tag=record_unlocked] run function ui:unlock/record
execute if entity @a[scores={ui_r_game=1..}] run advancement grant @s only ui:hidden/misc/party_time
