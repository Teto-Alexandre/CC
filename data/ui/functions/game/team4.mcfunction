# 即席チーム
    ...
    scoreboard players set @r[tag=!spectate,scores={ui_team=0}] ui_team 4
    scoreboard players set @r[tag=!spectate,scores={ui_team=0}] ui_team 1
    scoreboard players set @r[tag=!spectate,scores={ui_team=0}] ui_team 2
    scoreboard players set @r[tag=!spectate,scores={ui_team=0}] ui_team 3
    scoreboard players set @r[tag=!spectate,scores={ui_team=0}] ui_team 4
...
# 放送
    ...
    tellraw @a[tag=!spectate,scores={ui_team=4}] ["",{"text":"system>> ","color":"white"},{"text":"あなたは","color":"gray"},{"text":" GREEN ","color":"green"},{"text":"チームです","color":"gray"}]