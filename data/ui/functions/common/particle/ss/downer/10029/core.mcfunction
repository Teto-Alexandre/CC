...
scoreboard players set $count ui_temp 45
execute at @s if block ~ ~-0.1 ~ #ui:nocol run function ui:common/particle/ss/downer/10018/inair
execute if entity @e[distance=..1.1,predicate=ui:load_unhurtable,tag=!ui_temp_team] run function ui:common/particle/ss/downer/10029/hit
