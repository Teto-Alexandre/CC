...
function ui:common/particle/ss/downer/10110/l1/l1_0
...
execute if score $is2 ui_temp matches 1 if score $is ui_temp matches 3 run data merge storage ui:common {input:{Mode:"create",Var:-10109,Var2:1}}
execute if score $is2 ui_temp matches 1 if score $is ui_temp matches 3 run function ui:common/particle
